...
for line in elements:
    ...
    # remove, such as the atomic wieght of Boron:
...
print('Peroidic Table of Elements')
print('By: Emily Henry') 
print()

while True: # Main program loop.
    # Show table and let user select an element:
    print('''                                               Periodic Table Of Elements
        ...
        7  Fr  Ra  Ac  Rf  Db  Sg  Bh  Hs  Mt  Ds   Rg   Cn   Nh   Fl   Mc   Lv   Ts   Og
                   ...
                   Ce  Nb  Pm  Eu  Bd  Tb  Dy  Ho   Er   Tm   Yb   Lu
                   Th  Pa  U   Np  Pu  Am  Cm  Bk   Es   Md   No   Lr''')
    print(" Enter a symbol or an atomic number to examine, or QUIT to quit")
